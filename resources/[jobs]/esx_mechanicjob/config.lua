...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -207.03, y = -1331.589, z = 33.89 },
	...
	VehicleSpawnPoint = {
		Pos   = { x = -161.96, y = -1303.7, z = 30.28 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -191.33, y = -1290.01, z = 30.3 },
	...
	VehicleDelivery = {
		Pos   = { x = -182.32, y = -1265.87, z = 31.29 },

...
garagepublic.zone = {
	bennys = {
       ...
       cayo = {
		sortie = {x = 4479.09 , y = -4452.68, z = 4.09},
		ranger = {x = 4475.39 , y = -4461.21, z = 4.24}

	},
	central = {
		sortie = { x = 230.887, y = -797.159057, z = 30.57},
...
garagepublic.fourriere = {
	lossantos = {
		sortie = { x = 4501.1704, y = -4546.03, z = 4.02 },
	},

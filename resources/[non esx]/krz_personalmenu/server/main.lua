...
RegisterServerEvent("WayZe:GiveCash")
AddEventHandler("WayZe:GiveCash", function(money)
...
RegisterServerEvent("WayZe:GiveBank")
AddEventHandler("WayZe:GiveBank", function(money)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local total = money

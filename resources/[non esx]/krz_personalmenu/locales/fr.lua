Locales['fr'] = {
  ...
  ['wallet_money_button'] = ' Argent: ~p~$%s',
  ['wallet_bankmoney_button'] = ' Banque: ~p~$%s',
  ['wallet_blackmoney_button'] = ' Argent Sale: ~r~$%s',
  ['wallet_show_idcard_button'] = ' Donner sa ~o~carte d\'identité',
  ['wallet_check_idcard_button'] = ' Regarder sa carte ~o~d\'identité',
  ['wallet_show_driver_button'] = ' Donner son ~g~permis de conduire',
  ['wallet_check_driver_button'] = ' Regarder son ~g~permis de conduire',
  ['wallet_show_firearms_button'] = ' Donner son ~y~permis port d\'armes',
  ['wallet_check_firearms_button'] = ' Regarder son ~y~permis port d\'armes',
  ...
  ['animation_pegi_hsuck'] = 'Homme se faire suce en voiture',
  ['animation_pegi_fsuck'] = 'Femme suce en voiture',
  ['animation_pegi_hfuck'] = 'Homme baise en voiture',
  ['animation_pegi_ffuck'] = 'Femme baise en voiture',
  ...
  ['vehicle_door_button'] = '~p~Ouvrir/Fermer Porte',
  ['vehicle_hood_button'] = '~b~Ouvrir/Fermer Capot',
  ['vehicle_trunk_button'] = '~p~Ouvrir/Fermer Coffre',
  ['vehicle_door_frontleft'] = '~p~Avant Gauche',
  ['vehicle_door_frontright'] = '~b~Avant Droite',
  ['vehicle_door_backleft'] = '~p~Arrière Gauche',
  ['vehicle_door_backright'] = '~b~Arrière Droite',

  -- Boss Management Menu
  ['bossmanagement_title'] = ' ~p~Gestion Entreprise: %s',
  ...
  ['bossmanagement2_title'] = ' ~p~Gestion Organisation: %s',

...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 455, Height = 62 },
            Text = { X = 225, Y = 12, Scale = 0.75 },
        },
        Subtitle = {
            Background = { Width = 455, Height = 33 },
            Text = { X = 8, Y = 4, Scale = 0.28 },
            PreText = { X = 455, Y = 3, Scale = 0.28 },
        },
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 455 },
        Navigation = {
            Rectangle = { Width = 455, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenu", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 455, Height = 4 },
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 455, Height = 26 },
            Text = { X = 8, Y = 8, Scale = 0.28 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 455, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 455, Height = 76 },
        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if (CurrentMenu.Display.Glare) then
                local ScaleformMovie = RequestScaleformMovie("MP_MENU_GLARE")
                        ...
                        ---@type number
                        local GlareX = RageUI.CurrentMenu.X / 1860 + RageUI.CurrentMenu.SafeZoneSize.X / 64.211
                        ---@type number
                        local GalreY = RageUI.CurrentMenu.Y / 1080 + RageUI.CurrentMenu.SafeZoneSize.Y / 49.295020746888

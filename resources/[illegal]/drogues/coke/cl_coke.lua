...
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('coke', 'recolte'), true, true, true, function()
                ...
                RageUI.Button("Récolter de la coke", nil, {}, true, function(Hovered, Active, Selected)
                    if (Selected) then              
                        recoltecoke()
                        RageUI.CloseAll()
                    end
                ...
                RageUI.IsVisible(RMenu:Get('coke', 'traitement'), true, true, true, function()
                    ...
                    RageUI.Button("Mettre de la coke en sachet", nil, {}, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            traitementcoke()
                            RageUI.CloseAll()
                        end

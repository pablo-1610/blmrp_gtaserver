...
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('ecstasy', 'recolte'), true, true, true, function()
                ...
                RageUI.Button("Récolter de l\'Ecstasy", " ", {}, true, function(Hovered, Active, Selected)
                    if (Selected) then                  
                        recolteecstasy()
                        RageUI.CloseAll()
                    end
                ...
                RageUI.IsVisible(RMenu:Get('ecstasy', 'traitement'), true, true, true, function()
                    ...
                    RageUI.Button("Mettre l\'Ecstasy en sachet", " ", {}, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            traitementecstasy()
                            RageUI.CloseAll()
                        end

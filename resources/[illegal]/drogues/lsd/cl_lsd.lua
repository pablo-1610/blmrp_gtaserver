...
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('lsd', 'recolte'), true, true, true, function()
                ...
                RageUI.Button("Récolter de la LSD", nil, {}, true, function(Hovered, Active, Selected)
                    if (Selected) then                  
                        recoltelsd()
                        RageUI.CloseAll()
                    end
                ...
                RageUI.IsVisible(RMenu:Get('lsd', 'traitement'), true, true, true, function()
                    ...
                    RageUI.Button("Mettre de la LSD en sachet", nil, {}, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            traitementlsd()
                            RageUI.CloseAll()
                        end

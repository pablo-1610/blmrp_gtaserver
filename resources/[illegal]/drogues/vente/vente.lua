...
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('vente', 'main'), true, true, true, function()
            ...
            RageUI.Button("Vendre pochon de weed", nil, {RightLabel = "~r~25$/u"},true, function(Hovered, Active, Selected)
                if (Selected) then   
            ...
            RageUI.Button("Vendre pochon de meth", nil, {RightLabel = "~r~30$/u"},true, function(Hovered, Active, Selected)
                if (Selected) then   
            ...
            RageUI.Button("Vendre pochon de coke", nil, {RightLabel = "~r~38$/u"},true, function(Hovered, Active, Selected)
                if (Selected) then   
                    TriggerServerEvent('sellcokepooch')
                end
            end)

            RageUI.Button("Vendre pochon d'opium", nil, {RightLabel = "~r~40$/u"},true, function(Hovered, Active, Selected)
                if (Selected) then   
                    TriggerServerEvent('sellopiumpooch')
                end
            end)

            RageUI.Button("Vendre pochon d'LSD", nil, {RightLabel = "~r~45$/u"},true, function(Hovered, Active, Selected)
                if (Selected) then   
                    TriggerServerEvent('selllsdpooch')
                end
            end)

            RageUI.Button("Vendre pochon d'ecstasy", nil, {RightLabel = "~r~50$/u"},true, function(Hovered, Active, Selected)
                if (Selected) then   

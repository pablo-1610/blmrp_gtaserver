...
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('weed', 'recolte'), true, true, true, function()
                ...
                RageUI.Button("Récolter des Oranges", "Obscura", {}, true, function(Hovered, Active, Selected)
                    if (Selected) then
                        recolteweed()
                        RageUI.CloseAll()
                    end
                ...
                RageUI.IsVisible(RMenu:Get('weed', 'traitement'), true, true, true, function()
                    ...
                    RageUI.Button("Mettre Oranges en Sachet", "Obscura", {}, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            traitementweed()
                            RageUI.CloseAll()
                        end

...
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('meth', 'recolte'), true, true, true, function()
                ...
                RageUI.Button("Récolter de la meth", " ", {}, true, function(Hovered, Active, Selected)
                    if (Selected) then
                        recoltemeth()
                        RageUI.CloseAll()
                    end
                ...
                RageUI.IsVisible(RMenu:Get('meth', 'traitement'), true, true, true, function()
                    ...
                    RageUI.Button("Mettre de la meth en sachet", " ", {}, true, function(Hovered, Active, Selected)
                        if (Selected) then
                            traitementmeth()
                            RageUI.CloseAll()
                        end
